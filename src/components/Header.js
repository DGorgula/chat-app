...
function Header({ user }) {
    ...
    return (
        <>
            ...
            {isMenuOpen && <ul id="menu" onMouseLeave={() => setIsMenuOpen(false)}><li onClick={logout}><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="menu-icon" viewBox="0 0 16 16">
